public partial class GameEvents {
  ...
  public const string
    AttackPiece = "attack_piece"; // Piece will be attacked with an AttackAction (can be cancelled)

  public const string PieceTaken = "piece_taken"; // Piece has been taken

  public const string
    MovePiece = "move_piece"; // Piece will be moved with a MoveAction (can be cancelled)
